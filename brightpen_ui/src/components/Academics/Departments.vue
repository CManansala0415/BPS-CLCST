            ...
            <div class="relative w-full md:basis-3/4 bg-gray-100 flex flex-col shadow-md">
                <div class="p-5 overflow-auto min-h-80">
                    <div class=" border-0 border-b border-gray-400">
                        <h3 class="mb-3 text-md font-extrabold">Deparments</h3>
                    </div>
                    ...
                    <div class="grid grid-cols-4 border-0 border-b border-gray-300 p-3">
                        <div class="flex items-center">
                            <p class="text-xs">Information Technology</p>
                        </div>
                        <div class="flex items-center">
            ...
            <div class="w-full md:basis-1/2 bg-gray-100">
                <div class="p-5 flex flex-col gap-3">
                    <div class="flex flex-col text-center">
                        <p class="text-xs font-semibold">Deparment Settings</p>
                    </div>
                    <div class="flex flex-col">
                        <p class="text-xs mb-1">Deparment Title</p>
                        <input type="text" class="text-xs p-1 border border-gray-400 rounded-md shadow-md shadow-gray-300"/>
                    </div>
                    <div class="flex flex-col">
                        <p class="text-xs mb-1">Deparment Code</p>
                        <input type="text" class="text-xs p-1 border border-gray-400 rounded-md shadow-md shadow-gray-300"/>
                    </div>
                   
                    <div class="flex flex-col gap-2">
                        <button type="button" class="px-4 py-2 bg-green-500 hover:bg-green-400 text-gray-200 text-xs"><i class="fa-solid fa-floppy-disk mr-2"></i>Register Deparment</button> 
