...
const loadData = (data) =>{
    ...
    items.value.prog_semtype = data[0].prog_semtype

    items.value.dprog_y1.semester_1_units = data[0].dprog_s1
    items.value.dprog_y1.semester_2_units = data[0].dprog_s2
    items.value.dprog_y1.semester_3_units = data[0].dprog_s3
    items.value.dprog_y1.year1_id = data[0].dprog_id


    items.value.dprog_y2.semester_1_units = data[1].dprog_s1
    items.value.dprog_y2.semester_2_units = data[1].dprog_s2
    items.value.dprog_y2.semester_3_units = data[1].dprog_s3
    items.value.dprog_y2.year2_id = data[1].dprog_id

    items.value.dprog_y3.semester_1_units = data[2].dprog_s1
    items.value.dprog_y3.semester_2_units = data[2].dprog_s2
    items.value.dprog_y3.semester_3_units = data[2].dprog_s3
    items.value.dprog_y3.year3_id = data[2].dprog_id

    items.value.dprog_y4.semester_1_units = data[3].dprog_s1
    items.value.dprog_y4.semester_2_units = data[3].dprog_s2
    items.value.dprog_y4.semester_3_units = data[3].dprog_s3
    items.value.dprog_y4.year4_id = data[3].dprog_id

    items.value.mode = 2 // 2 means update
    items.value.id = propID.value // 2 means update
    items.value.id = propID.value // 2 means update
